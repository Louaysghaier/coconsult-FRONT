         ...
         //hide main component
              ...
              this.router.events.subscribe((event: RouterEvent) => {
                if (event instanceof NavigationEnd) {
                  this.isDashboardRoute = event.url.includes('admin')|| event.url.includes('user') || event.url.includes('verification')||event.url.includes('chat')||event.url.includes('contact')||event.url.includes('job')||event.url.includes('profil')||event.url.includes('chatc')
